<script lang="ts">
    let { message, type = "success", duration = 3000 } = $props<{
        message: string;
...
{#if visible}
<div class="fixed bottom-24 left-1/2 transform -translate-x-1/2 z-50 animate-slide-up">
    ...
    <!-- Progress bar -->
    <div class="w-full bg-gray-300 h-1 rounded-b-lg overflow-hidden">
        <div 
            class={`h-full ${
